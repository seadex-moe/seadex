...
<div class="w-full max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
  ...
  <section class="rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-3">
    ...
    <ul class="space-y-2 list-disc list-inside">
      ...
      <li>
        ...
        <a href="https://discord.gg/seadex" target="_blank" rel="noopener noreferrer"
           class="text-blue-600 dark:text-blue-400 hover:underline">
          on our Discord
        </a>
      </li>
...
<section class="rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-4">
  ...
  <section class="rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-3">
    ...
    <p>If you find any discrepancies in entries between the two, please report them
      <a href="https://discord.gg/seadex" class="text-blue-600 dark:text-blue-400 hover:underline">on our Discord</a>.
    </p>
